...
>
	...
	<div>
		<ol class="group/list">
			{#each data.workHistory as workHistory}
		...
		<div class="mt-12">
			<a
				...
				><span
					><span
						class="border-b border-transparent pb-px transition group-hover:border-white motion-reduce:transition-none"
						>View Full<!-- -->
...
>
	<div
		class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0"
	>
		<h2 class="text-sm font-bold uppercase tracking-widest text-slate-200 lg:sr-only">Collaborative Project
			Contributions</h2>
	</div>
	...
	<div class="lg:pt-28">
		...
		class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0"
	>
		<h2 class="text-sm font-bold uppercase tracking-widest text-slate-200 lg:sr-only">Personal Projects</h2>
	</div>

	<ProjectContainer>
		{#each data.personal_projects as projects}
			<Projects {projects} />
		{/each}
	</ProjectContainer>
	</div>
