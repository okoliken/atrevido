...
<svelte:head>
	...
	<meta name="description" content="I Build Inclusive and Accessible Web Experiences, One Line of Code at a Time." />
</svelte:head>
...
<div class="relative">
	...
	>
		<div class="lg:flex lg:justify-between lg:gap-4 font-Raleway">
			...
			>
				<div>
					<h1 class="text-4xl font-bold tracking-wide text-slate-100 sm:text-5xl">
						Okoli Jahbuchim
					</h1>
					...
					<p class="mt-4 max-w-xs leading-normal text-gray-400 font-light">
						I Build Inclusive and Accessible Web Experiences, One Line of Code at a Time.
					</p>
				...
				<footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
					<p>
						...
						<a
							...
							target="_blank"
							rel="noreferrer">Brittany Chiang's Portfolio</a
						>
						<!-- -->and coded in<!-- -->
						<a
